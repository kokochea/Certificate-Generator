...
if __name__ == "__main__":
    ...
    signature_images = {"coordinator": "assets/firmaCM.png", "director": "assets/firmaEC.jpg"}
    description_text = "Curso dictado en Montevideo, desde el 23 de agosto al 6 de diciembre de 2024."
    objective_text = "Aplicar conocimientos de ciberseguridad de manera efectiva."
    study_plan_items = ["Módulo 1", "Módulo 2"]
